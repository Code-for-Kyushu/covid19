...
<i18n>
{
  "ja": {
    ...
    "地下鉄の利用者数の推移": "地下鉄の利用者数の推移",
    "九州発生（疑い例・接触者調査）": "九州発生（疑い例・接触者調査）",
  ...
  "en": {
    ...
    "地下鉄の利用者数の推移": "The predicted number of Toei subway passengers",
    "九州発生（疑い例・接触者調査）": "Emerged in Tokyo (Suspected cases or contactees)",
  ...
  "zh-cn": {
    ...
    "地下鉄の利用者数の推移": "都营地下铁搭乘人数趋势",
    "九州発生（疑い例・接触者調査）": "东京都案例（疑似感染、接触者调查）",
  ...
  "zh-tw": {
    ...
    "地下鉄の利用者数の推移": "都營地下鐵搭乘人數走勢",
    "九州発生（疑い例・接触者調査）": "九州案例（疑似感染、接觸者調查）",
  ...
  "ko": {
    ...
    "地下鉄の利用者数の推移": "도에이 지하철 의 예상 승객 수",
    "九州発生（疑い例・接触者調査）": "도쿄 지역사회 발생 경우（의심환자, 접촉자）",
  ...
  "ja-basic": {
    ...
    "地下鉄の利用者数の推移": "とえいちかてつを つかった ひとの かず",
    "九州発生（疑い例・接触者調査）": "とうきょうとで びょうき かもしれない ひと",
...
export default {
  ...
  data() {
    ...
    const inspectionsGraph = [
      Data.inspections_summary.data['九州'],
      Data.inspections_summary.data['その他']
    ]
    const inspectionsItems = [
      this.$t('九州発生（疑い例・接触者調査）'),
