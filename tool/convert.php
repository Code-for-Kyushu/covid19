...
{
  $data = xlsxToArray(__DIR__.'/downloads/九州患者発生発表数-RAW.xlsx', 'RAW', 'A2:J100', 'A1:J1');
  ...
  return [
    'date' => xlsxToArray(__DIR__.'/downloads/九州患者発生発表数-RAW.xlsx', 'RAW', 'M1')[0][0],
    'data' => [
...
function readInspectionsSummary(array $inspections) : array
{
  return [
    ...
    'data' => [
      '九州' => $inspections['data']->map(function ($row) {
